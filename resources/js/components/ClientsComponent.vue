...
<div class="container">
  <h2 class=" float-left"> Espace Client</h2>
  <!-- Trigger the modal with a button --><div class="card-tools">
                  <button class=" float-right btn btn-success" @click="newModal">
                    <i class="fas fa-user-plus fa fw"></i> Ajouter client
                  </button>
                </div>
<br><br>
  <!-- Modal -->
